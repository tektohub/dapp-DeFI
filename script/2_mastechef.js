...
const script = async () => {
    ...
    masterChef.methods.add(3000, LP_fUSDC_WETH_address, true).send({from: accounts[0]})
    masterChef.methods.add(2000, LP_fUSDT_WETH_address, true).send({from: accounts[0]})
    masterChef.methods.add(5000, LP_fDAI_WETH_address, true).send({from: accounts[0]})
}
